...
**Refactoring code** means re-writing code **__without__** changing its function. Refactoring is meant to make code understandable and/or reusable for yourself. 
